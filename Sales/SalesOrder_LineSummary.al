page 50109 SalesOrderLineSummary
{
    ...
    layout
    {
        area(content)
        {
            group(SalesLine)
            {
                ...
                { ApplicationArea = All; Caption = 'Amount Incl. VAT'; Visible = true; Editable = false; }
            ...
            group(Control51)
            {
                Caption = 'Order Sub-totals and Totals';
                group(Control45)
                {
                    ShowCaption = false;
...
#pragma warning restore AA0219
    ...
    var
        ItemAvailFormsMgt2: Codeunit "Item Availability Forms Mgt";
