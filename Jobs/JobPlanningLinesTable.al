tableextension 50107 JobPlanningLinesExt extends "Job Planning Line"
{
    fields
    {
        ...
        { Caption = 'Work Done'; DataClassification = CustomerContent; }
        field(50101; "InvoicePrice"; Decimal)
        { Caption = 'Invoice Price'; DataClassification = CustomerContent; }
        field(50102; "InvoiceCost"; Decimal)
        { Caption = 'Invoice Cost'; DataClassification = CustomerContent; }
