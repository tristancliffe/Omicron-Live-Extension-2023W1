    ...
    layout
    {
        area(content)
        {
            group(Type)
            {
                ...
                field(NonStockShelfNo; Rec.NonStockShelf)
                { ApplicationArea = All; Caption = 'Non-Stock Shelf'; Visible = true; DrillDown = false; }
                field(ItemType; Rec.Type)
                { ApplicationArea = All; Caption = 'Item Type'; Visible = true; DrillDown = false; }
                field(ItemReplenishment; Rec."Replenishment System")
                { ApplicationArea = All; Caption = 'Replenishment'; Visible = true; DrillDown = false; }
                field(ItemVendor; Rec."Vendor No.")
                { ApplicationArea = All; Visible = true; Drilldown = true; }
                field(ItemVendorNo; Rec."Vendor Item No.")
                { ApplicationArea = All; Visible = true; DrillDown = false; }
                field(ItemQtyOnOrder; Rec."Qty. on Purch. Order")
                { ApplicationArea = All; Visible = true; DrillDown = true; }
                field(ItemReorderPolicy; Rec."Reordering Policy")
                { ApplicationArea = All; Caption = 'Reorder Policy'; Visible = true; DrillDown = false; }
                field(ItemReorderPoint; Rec."Reorder Point")
                { ApplicationArea = All; Caption = 'Reorder Qty'; Visible = true; DrillDown = false; }
                field(ItemReorderQty; Rec."Reorder Quantity")
                { ApplicationArea = All; Caption = 'Item Type'; Visible = OrderFixed; DrillDown = false; }
                field(ItemMaxInventory; Rec."Maximum Inventory")
                { ApplicationArea = All; Caption = 'Max Inventory'; Visible = OrderMax; DrillDown = false; }
            }
            group(Notes)
            {
                Caption = 'Item Notes';
