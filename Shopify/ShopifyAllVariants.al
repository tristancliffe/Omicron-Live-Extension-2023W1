page 50102 ShopifyAllVariants
{
    ...
    layout
    {
        area(content)
        {
            ...
            {
                field(Id; Rec.Id)
                { ApplicationArea = All; ToolTip = 'Specifies the unique numeric identifier for the product variant. Each product has always one variant.'; }
                ...
                field(SKU; Rec.SKU)
                { ApplicationArea = All; ToolTip = 'Specifies the unique identifier for the product variant in the shop.'; }
                field(Price; Rec.Price)
                { ApplicationArea = All; ToolTip = 'Specifies the price of a product variant.'; }
                field(Barcode; Rec.Barcode)
                { ApplicationArea = All; ToolTip = 'Specifies the barcode, UPC, or ISBN number for the product.'; }
                field(UnitCost; Rec."Unit Cost")
                { ApplicationArea = All; ToolTip = 'Specifies the cost of one unit for the variant.'; }
                field(Weight; Rec.Weight)
                { ApplicationArea = All; ToolTip = 'Specifies the weight of the product variant.'; }
                ...
                { Caption = 'Display Name'; ApplicationArea = All; }
                field(Title; Rec.Title)
                { ApplicationArea = All; ToolTip = 'Specifies the title of the product variant. The title field is a concatenation of the option1, option2, and option3 fields.'; }
                field(OptionName1; Rec."Option 1 Name")
                { ApplicationArea = All; ToolTip = 'Specifies the custom properties that a shop owner uses to define product variants. You can define three options for a product variant.'; }
                field(OptionValue1; Rec."Option 1 Value")
                { ApplicationArea = All; ToolTip = 'Specifies the value of the first option.'; }
                field(OptionName2; Rec."Option 2 Name")
                { ApplicationArea = All; ToolTip = 'Specifies the custom properties that a shop owner uses to define product variants. You can define three options for a product variant.'; }
                field(OptionValue2; Rec."Option 2 Value")
                { ApplicationArea = All; ToolTip = 'Specifies the value of the second option.'; }
                field(OptionName3; Rec."Option 3 Name")
                { ApplicationArea = All; ToolTip = 'Specifies the custom properties that a shop owner uses to define product variants. You can define three options for a product variant.'; }
                field(OptionValue3; Rec."Option 3 Value")
                { ApplicationArea = All; ToolTip = 'Specifies the value of the third option.'; }
                field(AvailableForSales; Rec."Available For Sales")
                { ApplicationArea = All; ToolTip = 'Specifies if the variants is available for sales.'; }
                field(CreatedAt; Rec."Created At")
                { ApplicationArea = All; ToolTip = 'Specifies the date and time when the product variant was created.'; }
                field(UpdatedAt; Rec."Updated At")
                { ApplicationArea = All; ToolTip = 'Specifies the date and time when the product variant was last modified.'; }
